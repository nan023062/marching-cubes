bl_info = {
    "name": "MQ ArtMesh – Marching Squares Mesh Tool",
    "author": "MarchingCubes Project",
    "version": (1, 0, 0),
    "blender": (3, 0, 0),
    "category": "Mesh",
    "description": "Helper for authoring Marching Squares tile meshes (16 cases, 6 canonical).",
}
...
def register():
    ...
    bpy.types.Scene.mq_props = bpy.props.PointerProperty(type=MQProperties)
